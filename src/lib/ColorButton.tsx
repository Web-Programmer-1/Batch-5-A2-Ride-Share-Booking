...
const AnimatedBadge = ({
  ...
  return (
    <div
      className={`rounded-full p-[1px] bg-gradient-to-r ${borderColor} [background-size:400%_100%] ${className}`}
...
// View Component with only one badge
      ...
      >
        <div className="z-10 flex flex-col items-center gap-8">
          <AnimatedBadge
            text="Sera UI"
            icon={<FlowerIcon />}
            borderColor="from-sky-500 via-purple-500 to-green-400"
          />
        </div>
      </section>
    </>
