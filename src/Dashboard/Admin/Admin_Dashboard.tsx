...
import { FaSearch, FaFilter, FaBars, FaUser, FaUserTie, FaChartLine, FaChartPie } from "react-icons/fa";
...
const tabs: TabItem[] = [
 { label: "User Management", icon: <FaUserTie className="inline-block mr-2" /> },
  { label: "Ride Monitoring", icon: <FaChartLine className="inline-block mr-2" /> }, 
 { label: "Analytics Dashboard", icon: <FaChartPie className="inline-block mr-2" /> },
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "Ride Monitoring":
        return <RideOversight></RideOversight>;
      ...
      <div className="flex-1 p-4 md:p-8 w-full">
        ...
        <div className="flex items-center justify-between mb-6 md:mb-8">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-gray-600 mt-1 text-lg md:text-base">
